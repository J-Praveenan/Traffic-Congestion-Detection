  ...
  <div className="min-h-screen bg-white flex justify-center items-center">
    <div className="flex flex-row items-center justify-center w-full gap-8 p-4">
      ...
      <div className="flex flex-col items-center bg-white shadow-lg rounded-lg p-8 w-full max-w-xl">
        <h1 className="text-3xl font-bold mb-4 text-center">Traffic Congestion Detection</h1>

        <input type="file" accept="image/*,video/*" onChange={handleFileChange} className="mb-4 hover:bg-blue-200 bg-white shadow-lg border-1 rounded-xl border-gray-300 p-0.5" />
...
<div className="grid grid-cols-2 gap-6 mb-4 w-full">
  ...
  <div className="mt-6 w-full text-center">
    <h2 className="text-xl font-semibold mb-2">Detection Result Video:</h2>
    <video
    ...
    />
        ...
        {trafficData && (
          <div className="mt-4 p-4 bg-gray-100 rounded shadow-inner w-full">
            ...
            <p><strong>FPS:</strong> {trafficData.fps}</p>
            <p><strong>Total Vehicles:</strong> {trafficData.total_cars}</p>
            <p><strong>Left Street Cars:</strong> {trafficData.left_street_cars}</p>
            <p><strong>Right Street Cars:</strong> {trafficData.right_street_cars}</p>
            <p><strong>Traffic Condition:</strong> {trafficData.road_condition}</p>
          </div>
        )}
      </div>
